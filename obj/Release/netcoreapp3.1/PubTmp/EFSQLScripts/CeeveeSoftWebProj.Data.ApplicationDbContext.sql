...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211127050216_Reset')
BEGIN
...
BEGIN
    CREATE TABLE [Certifications] (
        [CertificationId] int NOT NULL IDENTITY,
        [PortfolioId] int NOT NULL,
        [CertificationNo] nvarchar(max) NULL,
        [NameOfCertification] nvarchar(max) NULL,
        [IssuingBody] nvarchar(max) NULL,
        [IsuueDate] datetime2 NOT NULL,
        CONSTRAINT [PK_Certifications] PRIMARY KEY ([CertificationId]),
        CONSTRAINT [FK_Certifications_Portfolios_PortfolioId] FOREIGN KEY ([PortfolioId]) REFERENCES [Portfolios] ([Id]) ON DELETE CASCADE
    );
END;
...
IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211127050216_Reset')
BEGIN
    CREATE INDEX [IX_Certifications_PortfolioId] ON [Certifications] ([PortfolioId]);
END;
...
BEGIN
    ...
    VALUES (N'20211127050216_Reset', N'3.1.21');
END;

GO

IF NOT EXISTS(SELECT * FROM [__EFMigrationsHistory] WHERE [MigrationId] = N'20211127052540_Initial')
BEGIN
    CREATE TABLE [AspNetRoles] (
        [Id] nvarchar(450) NOT NULL,
        [Name] nvarchar(256) NULL,
...
BEGIN
    INSERT INTO [__EFMigrationsHistory] ([MigrationId], [ProductVersion])
    VALUES (N'20211127052540_Initial', N'3.1.21');
END;
